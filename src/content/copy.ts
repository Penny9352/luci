...
export const hero = {
  ...
  simulationAlt:
    '产品界面演示：用户请求把零散记录整理成周报，智能模式自动选定模型，回复分为本周完成、关键进展、遇到的问题、下周计划四段，生成的文件自动存入文件库。',
} as const
...
export const simulation = {
  ...
  blocks: [
    ...
    { heading: '关键进展', body: '与风控组敲定对账口径，历史差异样本已全部归档。' },
    { heading: '遇到的问题', body: '压测环境数据不足，下周需要业务侧补一批真实样本。' },
