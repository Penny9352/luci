 ...
 *  - 定时任务联网检索已研发确认，可对外书写（如「汇总今日行业新闻」）
 */
...
export const scheduled = {
  stage: '02',
  stageName: '定时任务',
  title: '设定一次，让 AI 持续替你工作',
  lead: '将重复性任务交给 AI，设定时间和任务后，系统即可自动完成信息搜集、分析整理、内容生成等工作，并将结果保存或推送到你常用的平台。',
  beats: ['定时执行', '自动处理', '结果交付', '多端推送'],
  tasks: [
    { when: '每天 08:30', what: '汇总今日行业新闻，生成一份 5 分钟晨报' },
    { when: '每周五 16:00', what: '整理本周工作记录，自动生成周报初稿' },
    { when: '每天 18:00', what: '跟踪重点数据和项目进展，发现异常时生成分析结果' },
  ],
  channels: {
    label: '结果去向',
    items: ['工作空间', '微信', '企业微信', '飞书'],
    note: '推送到 IM 需先扫码绑定',
  },
  config: {
