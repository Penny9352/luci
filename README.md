...
- `src/content/copy.en.ts` 顶部的术语表尚未定稿（「暴力模式 → Cross-Check
  ...
  和产品对不上号会让用户找不到东西。
- 页脚底栏是版权声明 `Copyright © 香港超昂控股有限公司 All Rights Reserved.`。
  **注意**：页脚品牌栏写的公司主体仍是「北京光忽智能科技有限公司」，与版权
  声明里的香港主体不是同一个 —— 上线前请确认这两处该显示哪一个，或两个都要。
  另外站点若托管在境内，ICP 备案号是监管要求，页面上现在已经没有了。
